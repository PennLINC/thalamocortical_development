...
Sample-specific final tract lists
```{r}
...
**Calculate mean FA for each tract in PNC and HCPD datasets**
...
**Thalamocortical connectivity FA differs by Mesulam cortical type**
...
ggsave(filename = "/cbica/projects/thalamocortical_development/figures/images/Figure3/FA_mesulamtype_PNC.pdf", device = "pdf", dpi = 500, width = 1.75, height = 1.3)
```

**Thalamocortical connectivity FA organization along the S-A axis**
...
perm.sphere.p(x = spin.data$mean_FA, y = spin.data$SA.axis, perm.id = perm.id.full, corr.type = "pearson") 
```
...
#identical(streamlinecount.glasser.pnc$rbcid, CPt.glasser.pnc$rbcid) = TRUE; internal check
...
#identical(names(streamlinecount.glasser.pnc), names(CPt.glasser.pnc)) = TRUE; internal check
...
#identical(streamlinecount.glasser.hcpd$rbcid, CPt.glasser.hcpd$rbcid) = TRUE; internal check
...
#identical(names(streamlinecount.glasser.hcpd), names(CPt.glasser.hcpd)) = TRUE; internal check
...
**Thalamocortical connectivity CPt differs by Mesulam cortical type**
...
**Thalamocortical connectivity CPt organization along the S-A axis**
...
perm.sphere.p(x = spin.data$mean_CPt, y = spin.data$SA.axis, perm.id = perm.id.full, corr.type = "pearson") 
```
